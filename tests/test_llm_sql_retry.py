...
from app.llm_service.llm_service import STAR_VALIDATION_MESSAGE, generate_sql


def _run_retry_test(question: str, second_sql: str):
    schema = SimpleNamespace(tables=[], metrics=[])
    ...
    async def run_test():
        with patch("app.llm_service.llm_service._get_session_config", return_value={
            ...
            "app.llm_service.llm_service.get_adapter",
